<?php
	...
	$imagename = $_FILES["floor_map_name"]["name"];
	$type = $_FILES["floor_map_name"]["type"];
    $tmp = $_FILES["floor_map_name"]["tmp_name"];
    $error = $_FILES["floor_map_name"]["error"];
    $floor_no = $_POST["floor_no"];
    $floor_name = $_POST["floor_name"];
    $insert_query = "INSERT INTO `floor_map`(`floor_map_name`, `floor_no`, `floor_name`) VALUES ('$imagename', '$floor_no', '$floor_name')";
    move_uploaded_file($tmp , "/Users/panchamkhaitan/Desktop/Projects/Indoor-Tracking/uploaded/".$imagename);
